...
Hubo ocho estados con más de 7.500 asesinatos: Baja California, Chihuahua, Jalisco, Michoacán, Guanajuato, Guerrero, Estado de México y Veracruz.
...
Podemos ver que las denuncias por asesinato tienen un volumen mucho mayor que las demás en México y también podemos ver los valores atípicos.
...
Para este ejercicio vamos a utilizar datos espaciales puntuales de los reportes de asesinatos en la Ciudad de México, el archivo "geopackage" que guardaste en la práctica anterior (murders_cdmx.gpkg).
